...
CONFIDENCE_THRESHOLD = 0.90    # Requires 55% certainty to move, otherwise defaults to NOOP
ACTION_COOLDOWN = 0.01    # Increased from 0.12 to give animations more time to settle
